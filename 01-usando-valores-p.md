# Usando valores p para probar una hipótesis
...
## Introducción al enfoque de prueba de hipótesis de Neyman-Pearson
...
## El valor $p$ y su distribución bajo $H_0$
...
## Errores Tipo II y Potencia (Power)
...
## Malentendidos comunes del valor $p$
...
## ¿Valor $p$ o enfoque de Neyman-Pearson?
