...
## La Importancia del Tamaño del Efecto (Effect Size, ES)
...
## Tipos de Tamaños del Efecto

Los tamaños del efecto se dividen generalmente en dos categorías:

### ES Estandarizados (Basados en la Varianza)
...
### ES No Estandarizados (Basados en la Métrica Original)
...
## Justificación del Tamaño del Efecto de Interés
...
## Intervalos de Confianza para el ES
