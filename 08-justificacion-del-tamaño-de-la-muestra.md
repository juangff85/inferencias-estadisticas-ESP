...
## ¿Por qué justificar el tamaño de la muestra?
...
## Enfoques para la Justificación del Tamaño de la Muestra

Existen seis enfoques principales para justificar el tamaño de la muestra:

### Planificación basada en el Control de Errores (Análisis de Potencia)
...
### Planificación basada en la Precisión (AIPE)
...
### Uso de Recursos o Restricciones
...
### Justificación Basada en la Adición de un Participante
...
### No hay justificación explícita
...
## Especificación del Tamaño del Efecto de Interés (ESOI)
...
## Realizar la Justificación y Reportarla
